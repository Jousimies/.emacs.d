...
#+begin_src emacs-lisp
  (add-to-list 'display-buffer-alist
               '("^.*\\.\\(org\\|md\\|tex\\|log\\)$"
                 (display-buffer-in-tab display-buffer-in-new-tab display-buffer-reuse-window)
                 (tab-name . "Edit")
                 (tab-group . "Edit")
                 (window-parameters . ((inhibit-same-window . t)))))
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'evil
      (evil-define-key '(normal visual) 'global
        "gsb" 'engine/search-bookdouban
        "gss" 'engine/search-google
        "gsg" 'engine/search-github
        "gsw" 'engine/search-wikipedia
        "gsm" 'engine/search-moviedouban
        "gsz" 'engine/search-zhihu
        "gsr" 'rg
        "gsl" 'consult-git-grep))
#+end_src
