...
#+begin_src emacs-lisp
  (use-package calc
    :commands calc
    :hook ((clac-mode . hide-mode-line-mode)
           (clac-trail-mode . hide-mode-line-mode)))
...
#+begin_src emacs-lisp
  (use-package flycheck
    :hook (on-first-file . global-flycheck-mode))
#+end_src
** flycheck-grammarly
...
#+begin_src emacs-lisp
  (use-package org-roam
    ...
    :hook ((org-mode . (lambda () (setq-local time-stamp-active t
           ...
           (on-first-input . org-roam-db-autosync-mode)
...
#+begin_src emacs-lisp
  ...
  (use-package citar-org
    :commands citar-org-local-bib-files citar-org-key-at-point
...
#+begin_src emacs-lisp
  (use-package ebib
    :bind ("<f2>" . ebib)
    :hook (ebib-index-mode . hide-mode-line-mode)
    :config
...
#+begin_src emacs-lisp
  (use-package reftex
    :hook ((LaTeX-mode . turn-on-reftex)
           ...
           (reftex-toc-mode . hide-mode-line-mode))
    :config
...
#+begin_src emacs-lisp
  ...
  (use-package pdf-outline
    :hook ((pdf-view-mode . pdf-outline-minor-mode)
           (pdf-outline-buffer-mode . hide-mode-line-mode))
